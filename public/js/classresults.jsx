...
class GreatCF extends React.Component {
  ...
  render() {
    return (<div className="greatcf">
      <p>Try the service with your own images <a className="base--a" href={this.bluemixURL()}>on Bluemix</a>.</p>
...
class WowFormInputForm extends React.Component {
  ...
  render() {
    ...
    return (<tr style={baseStyle} className="base--tr">
      ...
      <label><em className="base--em">Impressed?</em></label>
...
class ResultsTable extends React.Component {
  render() {
    return (<div className="use--output-data">
          ...
          { this.props.foodItems.length ? <FoodScoreTable category="Tank" rawjson={this.props.foodJson} items={this.props.foodItems}/> : <div style={{display: 'none'}}></div>}
